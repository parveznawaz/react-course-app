...
class ManageCoursePage extends Component {
    ...
    saveCourse(event) {
        ...
        // if (!this.courseFormIsValid()) {   return; } this.setState({saving: true});
        this
            .props
            .actions
...
// function mapStateToProps(state, ownProps) {     let course = {         id:
// '',         watchHref: '',         title: '',         authorId: '',
// length: '',         category: ''     };     const authorsFormattedForDropdown
// = state         .authors         .map(author => {             return {
//          value: author.id,                 text: author.firstName + ' ' +
// author.lastName             };         });     return {course: course,
